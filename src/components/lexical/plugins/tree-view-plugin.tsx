...
export const TreeViewPlugin = () => {
  ...
  return (
    <TreeView
      viewClassName="fixed left-0 bottom-0 block w-full h-[400px] overflow-y-auto py-10 bg-[#222] text-[#fff] p-0 text-xs mt-px mx-auto mb-2.5 overflow-hidden rounded-bl-lg rounded-br-lg"
