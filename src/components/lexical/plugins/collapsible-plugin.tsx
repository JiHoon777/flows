...
} from '@/components/lexical/nodes/collapsible/collapsible-container.node.ts'
import {
  $createCollapsibleContentNode,
  $isCollapsibleContentNode,
  CollapsibleContentNode,
} from '@/components/lexical/nodes/collapsible/collapsible-content-node.ts'
import {
  $createCollapsibleTitleNode,
  $isCollapsibleTitleNode,
  CollapsibleTitleNode,
} from '@/components/lexical/nodes/collapsible/collapsible-title-node.ts'
